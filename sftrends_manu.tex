...
{\centering \includegraphics[width=0.8\textwidth]{figs/obsdat-1} 

}

\caption{Observed \ac{din} from ten stations in the upper \ac{sfe} Delta.  Data were collected monthly and evaluated with \ac{wrtds} models from 1976 to 2013. Note different y-axis scales.  See \cref{fig:delt_map} for station locations.}\label{fig:obsdat}
\end{figure}
