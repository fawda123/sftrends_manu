...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Thu May 26 10:37:57 2016 -0500
	}
\date{}
\maketitle
\end{singlespace}
...
\begin{enumerate}
\item How and why are trends interpreted - assessment of raw data, surrogates, various methods (kendall, GAM, WRTDS), what have been implications of using different approaches
...
\begin{itemize}
\item Study location and data
\item WRTDS method - conceptual diagram
