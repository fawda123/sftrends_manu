...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Fri Jun 17 17:17:59 2016 -0500
	}
\date{}
\maketitle
\end{singlespace}
...
%latex.default(totab, file = "", rowlabel = "Period", caption = cap.val,     caption.loc = "top", rgroup = segs, n.rgroup = c(1, rep(4,         2)), cgroup = vars, n.cgroup = c(2, 2), rowname = cats,     label = "tab:chlsio")%
\begin{table}[!tbp]
