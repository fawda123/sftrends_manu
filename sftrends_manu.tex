...
\author{
  ...
  \vspace{1in}
  \\ Version Date:   Thu Oct 5 18:04:46 2017 -0700
	}
\date{}
\maketitle
\end{singlespace}
...
\caption[Model predictions]{Model predictions.}\label{fig:prddat}
\end{figure}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in gList(structure(list(data = list(structure(list(colour = c("{}\#66C2A5"{}, : only 'grobs' allowed in "{}gList"{}}}\end{kframe}
