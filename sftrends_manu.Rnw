...
%Peripheral high, but opposing trends at some stations - P8 highest for both ammonium and nitrite/nitrage but C3 also high in ammonium but not nitrite/nitrate, C10 low in ammonium but high in nitrite/nitrate
