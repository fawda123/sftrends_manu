...
Differences in apparent trends underscore the importance of considering flow effects in the interpretation of environmental changes, where flow in the Delta is affected by complex relationships between river inputs, water withdrawals, and tidal exchange with the larger Bay.     

Implications of different flow varialbes - refer to \cite{Novick15}, a hybrid approach would be best for complex systems like the delta. Huge effect on trend interpration
