...
The role of nutrients in stimulating primary production in \ac{sfe} has been the focus of several recent investigations\ \citep{Dugdale07,Parker12,Glibert14}. % see glibert14 description
